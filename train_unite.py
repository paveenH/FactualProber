...
def main():
    ...
    # Load datasets
    datasets, _ = load_datasets(dataset_names, layer, remove_period, input_path, sanitized_model_name)
    ...
    if save_probes:
        ...
        probe_path = probes_path / f"{probe_name}.pt"
    ...
    output_path = os.path.join(output_dir, f"{probe_name}_predictions.csv")
